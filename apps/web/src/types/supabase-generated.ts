// Generated by `pnpm db:types` (supabase gen types typescript --local).
// Do not hand-edit -- see apps/web/src/types/supabase.ts for the hand-
// maintained wrapper (narrowed enum aliases, re-exports) that the rest of
